...
export class BalancesBalanceSetEvent {
   ...
   * A balance was set by root. \[who, free, reserved\]
   */
  get asV2000(): [v2000.AccountId32, bigint, bigint] {
    assert(this.isV2000)
   ...
   * A balance was set by root.
   */
  get asV2011(): {who: v2011.AccountId32, free: bigint, reserved: bigint} {
    assert(this.isV2011)
    return this._chain.decodeEvent(this.event)
  }
}
...
export class BalancesDepositEvent {
   ...
   * deposit\]
   */
  get asV2000(): [v2000.AccountId32, bigint] {
    assert(this.isV2000)
    return this._chain.decodeEvent(this.event)
  }
   ...
   * Some amount was deposited (e.g. for transaction fees).
   */
  get asV2011(): {who: v2011.AccountId32, amount: bigint} {
    assert(this.isV2011)
    return this._chain.decodeEvent(this.event)
  }
}
...
export class BalancesEndowedEvent {
   ...
   * An account was created with some free balance.
   */
  get asV2011(): {account: v2011.AccountId32, freeBalance: bigint} {
    assert(this.isV2011)
    return this._chain.decodeEvent(this.event)
  }
}
...
export class BalancesReserveRepatriatedEvent {
   ...
   * \[from, to, balance, destination_status\]
   */
  get asV2000(): [v2000.AccountId32, v2000.AccountId32, bigint, v2000.BalanceStatus] {
    assert(this.isV2000)
    return this._chain.decodeEvent(this.event)
  }
   ...
   * Final argument indicates the destination balance type.
   */
  get asV2011(): {from: v2011.AccountId32, to: v2011.AccountId32, amount: bigint, destinationStatus: v2011.BalanceStatus} {
    assert(this.isV2011)
    return this._chain.decodeEvent(this.event)
  }
}
