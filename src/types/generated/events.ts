...
export class BalancesBalanceSetEvent {
   ...
   *  A balance was set by root. \[who, free, reserved\]
   */
  get asV1(): [v1.AccountId, v1.Balance, v1.Balance] {
    assert(this.isV1)
   ...
   * A balance was set by root.
   */
  get asV916(): {who: v916.AccountId32, free: bigint, reserved: bigint} {
    assert(this.isV916)
    return this._chain.decodeEvent(this.event)
  }
}
...
export class BalancesDepositEvent {
   ...
   * Some amount was deposited (e.g. for transaction fees).
   */
  get asV916(): {who: v916.AccountId32, amount: bigint} {
    assert(this.isV916)
    return this._chain.decodeEvent(this.event)
  }
}
...
export class BalancesEndowedEvent {
   ...
   * An account was created with some free balance.
   */
  get asV916(): {account: v916.AccountId32, freeBalance: bigint} {
    assert(this.isV916)
    return this._chain.decodeEvent(this.event)
  }
}
...
export class BalancesReserveRepatriatedEvent {
   ...
   *  \[from, to, balance, destination_status\]
   */
  get asV1(): [v1.AccountId, v1.AccountId, v1.Balance, v1.BalanceStatus] {
    assert(this.isV1)
    return this._chain.decodeEvent(this.event)
  }
   ...
   * Final argument indicates the destination balance type.
   */
  get asV916(): {from: v916.AccountId32, to: v916.AccountId32, amount: bigint, destinationStatus: v916.BalanceStatus} {
    assert(this.isV916)
    return this._chain.decodeEvent(this.event)
  }
}
...
export class BalancesSlashedEvent {
   ...
   * amount_slashed\]
   */
  get asV908(): [v908.AccountId32, bigint] {
    assert(this.isV908)
    return this._chain.decodeEvent(this.event)
  }
