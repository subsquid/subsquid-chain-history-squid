...
export class BalancesBalanceSetEvent {
   ...
   *  A balance was set by root. \[who, free, reserved\]
   */
  get asV1000(): [v1000.AccountId, v1000.Balance, v1000.Balance] {
    assert(this.isV1000)
   ...
   * A balance was set by root.
   */
  get asV2010(): {who: v2010.AccountId32, free: bigint, reserved: bigint} {
    assert(this.isV2010)
    return this._chain.decodeEvent(this.event)
  }
}
...
export class BalancesDepositEvent {
   ...
   *  Some amount was deposited (e.g. for transaction fees). \[who, deposit\]
   */
  get asV1000(): [v1000.AccountId, v1000.Balance] {
    assert(this.isV1000)
    return this._chain.decodeEvent(this.event)
  }
   ...
   * Some amount was deposited (e.g. for transaction fees).
   */
  get asV2010(): {who: v2010.AccountId32, amount: bigint} {
    assert(this.isV2010)
    return this._chain.decodeEvent(this.event)
  }
}
...
export class BalancesEndowedEvent {
   ...
   * An account was created with some free balance.
   */
  get asV2010(): {account: v2010.AccountId32, freeBalance: bigint} {
    assert(this.isV2010)
    return this._chain.decodeEvent(this.event)
  }
}
...
export class BalancesReserveRepatriatedEvent {
   ...
   *  \[from, to, balance, destination_status\]
   */
  get asV1000(): [v1000.AccountId, v1000.AccountId, v1000.Balance, v1000.BalanceStatus] {
    assert(this.isV1000)
    return this._chain.decodeEvent(this.event)
  }
   ...
   * Final argument indicates the destination balance type.
   */
  get asV2010(): {from: v2010.AccountId32, to: v2010.AccountId32, amount: bigint, destinationStatus: v2010.BalanceStatus} {
    assert(this.isV2010)
    return this._chain.decodeEvent(this.event)
  }
}
...
export class BalancesSlashedEvent {
   ...
   * amount_slashed\]
   */
  get asV2001(): [v2001.AccountId32, bigint] {
    assert(this.isV2001)
    return this._chain.decodeEvent(this.event)
  }
...
export class BalancesTransferEvent {
   ...
   *  Transfer succeeded. \[from, to, value\]
   */
  get asV1000(): [v1000.AccountId, v1000.AccountId, v1000.Balance] {
    assert(this.isV1000)
    return this._chain.decodeEvent(this.event)
  }
   ...
   * Transfer succeeded.
   */
  get asV2010(): {from: v2010.AccountId32, to: v2010.AccountId32, amount: bigint} {
    assert(this.isV2010)
    return this._chain.decodeEvent(this.event)
  }
}
