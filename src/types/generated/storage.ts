...
export class BalancesAccountStorage {
   ...
   *  NOTE: This is only used in the case that this pallet is used to store balances.
   */
  async getAsV1000(key: v1000.AccountId): Promise<v1000.AccountData> {
    assert(this.isV1000)
    return this._chain.getStorage(this.blockHash, 'Balances', 'Account', key)
  }

  async getManyAsV1000(keys: v1000.AccountId[]): Promise<(v1000.AccountData)[]> {
    assert(this.isV1000)
...
export class SystemAccountStorage {
   ...
   *  The full account information for a particular account ID.
   */
  async getAsV1000(key: v1000.AccountId): Promise<v1000.AccountInfo> {
    assert(this.isV1000)
    return this._chain.getStorage(this.blockHash, 'System', 'Account', key)
  }

  async getManyAsV1000(keys: v1000.AccountId[]): Promise<(v1000.AccountInfo)[]> {
    assert(this.isV1000)
