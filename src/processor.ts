...
function getBalanceSetAccount(ctx: ChainContext, event: Event) {
    ...
    if (data.isV155) {
        return toHex(data.asV155[0])
    } else if (data.isV200) {
        return toHex(data.asV200[0])
    } else if (data.isV1001) {
        return toHex(data.asV1001[0])
    } else if (data.isV1201) {
        return toHex(data.asV1201.who)
    } else if (data.isV1605) {
        return toHex(data.asV1605.who)
    } else {
...
function getTransferAccounts(ctx: ChainContext, event: Event) {
    ...
    if (data.isV155) {
        return [toHex(data.asV155[0]), toHex(data.asV155[1])]
    } else if (data.isV200) {
        return [toHex(data.asV200[0]), toHex(data.asV200[1])]
    } else if (data.isV1001) {
        return [toHex(data.asV1001[0]), toHex(data.asV1001[1])]
    } else if (data.isV1201) {
        return [toHex(data.asV1201.from), toHex(data.asV1201.to)]
    } else if (data.isV1605) {
        return [toHex(data.asV1605.from), toHex(data.asV1605.to)]
    } else {
        throw new UnknownVersionError(data.constructor.name)
    }
}
...
function getEndowedAccount(ctx: ChainContext, event: Event) {
    ...
    if (data.isV155) {
        ...
        return toHex(data.asV1201.account)
    } else if (data.isV1605) {
        return toHex(data.asV1605.account)
    } else {
        throw new UnknownVersionError(data.constructor.name)
    }
}
