...
export class BalancesBalanceSetEvent {
     ...
     * A balance was set by root.
     */
    get asV1090(): {who: Uint8Array, free: bigint, reserved: bigint} {
        assert(this.isV1090)
...
export class BalancesEndowedEvent {
     ...
     * An account was created with some free balance.
     */
    get asV1090(): {account: Uint8Array, freeBalance: bigint} {
        assert(this.isV1090)
        return this._chain.decodeEvent(this.event)
    }
}
...
export class BalancesReserveRepatriatedEvent {
     ...
     * Final argument indicates the destination balance type.
     */
    get asV1090(): {from: Uint8Array, to: Uint8Array, amount: bigint, destinationStatus: v1090.BalanceStatus} {
        assert(this.isV1090)
        return this._chain.decodeEvent(this.event)
    }
}
...
export class BalancesTransferEvent {
     ...
     * Transfer succeeded.
     */
    get asV1090(): {from: Uint8Array, to: Uint8Array, amount: bigint} {
        assert(this.isV1090)
        return this._chain.decodeEvent(this.event)
    }
}
