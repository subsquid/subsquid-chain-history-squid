...
export class BalancesBalanceSetEvent {
     ...
     * A balance was set by root. \[who, free, reserved\]
     */
    get asV2000(): [Uint8Array, bigint, bigint] {
        assert(this.isV2000)
     ...
     * A balance was set by root.
     */
    get asV2011(): {who: Uint8Array, free: bigint, reserved: bigint} {
        assert(this.isV2011)
        return this._chain.decodeEvent(this.event)
    }
}
...
export class BalancesDepositEvent {
     ...
     * Some amount was deposited (e.g. for transaction fees).
     */
    get asV2011(): {who: Uint8Array, amount: bigint} {
        assert(this.isV2011)
        return this._chain.decodeEvent(this.event)
    }
}
...
export class BalancesEndowedEvent {
     ...
     * An account was created with some free balance.
     */
    get asV2011(): {account: Uint8Array, freeBalance: bigint} {
        assert(this.isV2011)
        return this._chain.decodeEvent(this.event)
    }
}
...
export class BalancesReserveRepatriatedEvent {
     ...
     * \[from, to, balance, destination_status\]
     */
    get asV2000(): [Uint8Array, Uint8Array, bigint, v2000.BalanceStatus] {
        assert(this.isV2000)
        return this._chain.decodeEvent(this.event)
    }
     ...
     * Final argument indicates the destination balance type.
     */
    get asV2011(): {from: Uint8Array, to: Uint8Array, amount: bigint, destinationStatus: v2011.BalanceStatus} {
        assert(this.isV2011)
        return this._chain.decodeEvent(this.event)
    }
}
