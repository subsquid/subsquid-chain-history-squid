module.exports = class Data1656021182911 {
  name = 'Data1656021182911'
  ...
  async up(db) {
    ...
    await db.query(`CREATE TABLE "chain_state" ("id" character varying NOT NULL, "token_balance" numeric NOT NULL, "token_holders" integer NOT NULL, "council_members" integer NOT NULL, "democracy_proposals" integer NOT NULL, "council_proposals" integer NOT NULL, "timestamp" TIMESTAMP WITH TIME ZONE NOT NULL, "block_number" integer NOT NULL, CONSTRAINT "PK_e28e46a238ada7cbbcf711b3f6c" PRIMARY KEY ("id"))`)
